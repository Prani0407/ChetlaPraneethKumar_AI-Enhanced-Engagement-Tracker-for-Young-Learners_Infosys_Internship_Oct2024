...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        if distance < confidence_threshold:
            ...
            new_entry = pd.DataFrame({'Name': ['Praneeth Kumar'], 'Date': [date_str], 'Time': [time_str]})
    ...
    if recognition_count >= 5:
        ...
        df.to_excel('praneeth_attendence_save(4).xlsx', index=False)
...
if not df.empty:
    df.to_excel('praneeth_attendance(4).xlsx', index=False)

...
try:
    ...
    if not df.empty:
        df.to_excel('praneeth_attendance_with_attention(7).xlsx', index=False)
        print("Attendance with attentiveness saved to 'praneeth_attendance_with_attention(7).xlsx'.")
